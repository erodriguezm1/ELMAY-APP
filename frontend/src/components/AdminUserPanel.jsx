...
const AdminUserPanel = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      setError('Error al cargar los usuarios. Asegúrate de tener un token de administrador válido.');
      console.error(err);
  ...
  const handleModalConfirm = async () => {
    ...
    try {
      ...
      setError('Error al realizar la acción. Por favor, revisa la consola.');
